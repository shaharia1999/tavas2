                    ...
                    <div className="flex flex-col md:w-full">
                        ...
                        <form className="justify-center w-full mx-auto" method="post" action>
                            <div className="">
                                ...
                                <div className="mt-4">
                                    <button
                                        className="w-full px-6 py-2 text-white font-gilroy bg-[#121D45] hover:bg-blue-600">Process</button>
                                </div>
                            </div>
                        </form>
                    </div>
                            ...
                            <div className="mt-8">
                                <div className="flex flex-col space-y-4">
                                    <div className="flex space-x-4">
                                        <div>
                                            <img src="https://source.unsplash.com/user/erondu/1600x900" alt="image1" className="w-60" />
                                        </div>
                                        <div>
                                    ...
                                    <div className="flex space-x-4">
                                        <div>
                                            <img src="https://source.unsplash.com/collection/190727/1600x900" alt="image2"
                                                className="w-60" />
                                        </div>
                                        <div>
                                            <h2 className="text-xl font-bold">Title</h2>
